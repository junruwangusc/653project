...
HD_PWD='E:/Vivado Projects/MAC/MAC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiply_accumulater.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiply_accumulater.tcl
