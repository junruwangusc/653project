...
HD_PWD='E:/Vivado Projects/MAC/MAC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiply_accumulater.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiply_accumulater.tcl -notrace
